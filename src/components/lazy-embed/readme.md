...
| `loadOnVisible`       | `load-on-visible`        | Whether to load the preview image automatically when it becomes visible                             | `boolean` | `false`           |
| `playOnVisible`       | `play-on-visible`        | Whether to load the video automatically when it becomes visible                                     | `boolean` | `false`           |
