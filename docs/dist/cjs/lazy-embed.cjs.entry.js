...
const LazyEmbed = class {
    ...
    render() {
        ...
        if (!this.loaded) {
            return (index.h("div", { class: "lazy-embed-container", style: containerStyle }, index.h("div", { class: "preview-container" }, this.previewImage ? (index.h("img", { src: this.previewImage, alt: this.alt, class: "preview-image" })) : (index.h("div", { class: "placeholder" }, index.h("div", { class: "play-button" }))), index.h("div", { class: "play-overlay" }, index.h("div", { class: "play-button", "aria-label": "Play video" })))));
        }
        else {
            return (index.h("div", { class: "lazy-embed-container", style: containerStyle }, index.h("div", { class: "embed-responsive" }, index.h("iframe", { src: this.videoInfo.embedUrl, title: this.videoTitle || 'Embedded video', frameborder: "0", allow: "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture", allowfullScreen: true }))));
        }
    }
};
LazyEmbed.style = lazyEmbedCss;

exports.lazy_embed = LazyEmbed;
//# sourceMappingURL=lazy-embed.entry.cjs.js.map

//# sourceMappingURL=lazy-embed.cjs.entry.js.map